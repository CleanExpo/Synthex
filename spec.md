...
| 5   | **Agency / client-facing invoicing** — invoice an org's end-clients via Stripe; margin/passthrough                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Billing (#16)             | L   | High     | P2/P3    | `code-architect`                          | ✅ DONE (UNI-173): client invoice w/ line items + 10% GST, status workflow (draft→sent→paid→overdue→cancelled), Stripe payment-link, Resend send, PDF; `/api/invoices` (create), `/[id]` (GET/PATCH/DELETE), `/list`. Tests: invoices.test.ts (POST/GET/PATCH) + #541 (DELETE paid-guard + /list org-scope/filter/pagination) |
