...
| 13  | 🟡 **PARTIAL** (Twitter parity `#476` + IG Reels backend `#480` + Reel-slot media API `#543`; composer media-uploader UI + email-as-channel remain) **Publishing polish** — IG Stories/Reels UI; email-as-channel; Twitter `createPost` parity                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Publishing (#2,#13)       | M   | Low      | P1/P3    | `code-architect`                          | Story/Reel scheduling UI; email channel in queue; Twitter conforms to base                                                                                                                                                                                                                                                    |
