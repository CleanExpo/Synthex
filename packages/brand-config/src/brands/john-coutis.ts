...
export const johnCoutis = {
  // Every token below is unapproved — see the colour block's own note, "All
  // values are PROPOSAL — TODO confirm with John". Declared here so a preflight
  // can act on it instead of a reader having to notice a comment (SYN-1113).
  ...
  voice: {
    ...
    forbiddenWords: [
      ...
      'confined',
      'inspite',
      'despite' /* his framing is 'with', not 'despite' */,
  ...
  audience: {
    primary:
      'tradespeople and field operators across the property-services industry (NRPG members) — AU + NZ',
    secondary:
      'corporate audiences (leadership offsites, sales kick-offs) and school assemblies (anti-bullying, resilience)',
  },
