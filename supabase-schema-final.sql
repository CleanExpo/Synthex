-- ============================================
-- SYNTHEX PLATFORM - COMPLETE DATABASE SCHEMA (FINAL VERSION)
-- ============================================
...
-- ============================================
-- CAMPAIGNS TABLE (must be created before content)
-- ============================================
...
CREATE INDEX idx_content_persona ON public.content(persona_id);
...
-- ============================================
-- ANALYTICS TABLE (fixed - no campaign_id)
-- ============================================
...
-- ============================================
-- STEP 6: VIEWS (Optional - for easier querying)
-- ============================================
...
LEFT JOIN public.analytics a ON c.id = a.content_id
GROUP BY camp.id;
...
-- Check sample patterns were inserted
...
-- 
-- Important Notes:
-- 1. This script completely drops and recreates all tables
-- 2. All foreign key constraints have been properly ordered
-- 3. The analytics table correctly references content, not campaigns
-- 4. Run the verification queries to ensure everything is set up correctly
-- 
-- Next steps:
-- 1. Enable Authentication providers in Supabase Dashboard
-- 2. Update OAuth redirect URLs to your Vercel domain
