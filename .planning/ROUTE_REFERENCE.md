...
- `GET,POST /api/intentscape/workspaces` — user — _intentScapeWorkspace,intentScapeArtifact,intentScapeEvent_
- `GET /api/intentscape/workspaces/[id]` — user — _intentScapeWorkspace,intentScapeArtifact,intentScapeVisionRun,intentScapeHypothesis,intentScapeGoalContract,intentScapeEvent_
- `POST /api/intentscape/workspaces/[id]/signals` — user — _intentScapeWorkspace,intentScapeArtifact,intentScapeEvent_
...
| IntentScape                     | /dashboard/intentscape                   | `/api/intentscape/workspaces`, `/api/intentscape/workspaces/[id]`, `/api/intentscape/workspaces/[id]/signals`, `/api/intentscape/workspaces/[id]/expand`, `/api/intentscape/workspaces/[id]/approve-goal`, `/api/intentscape/workspaces/[id]/work-packet` |
