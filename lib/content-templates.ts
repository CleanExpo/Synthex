...
export const getTemplatesByPlatform = (
  platform: ContentTemplate['platforms'][number]
) => contentTemplates.filter(t => t.platforms.includes(platform));
...
export const searchTemplates = (query: string) => {
  ...
  return contentTemplates.filter(
    t =>
