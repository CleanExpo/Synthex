...
export const RESTOREASSIST_STUDIO_CONFIG: ClientStudioConfig = {
  ...
  consent: {
    subjectName: process.env.RA_PRESENTER_NAME ?? 'RestoreAssist Presenter (placeholder)',
...
/** Registry — new clients (CCW, Disaster Recovery, CARSI, …) get added here as they come online. */
