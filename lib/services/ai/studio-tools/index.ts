...
export const STUDIO_TOOLS: StudioTool[] = [
  {
    ...
    // WS3b (SYN-1075, spec section 8(3)): deriveSocialCut() itself calls
    // assertGatePassed(heroAssetId, 'broadcast') before it creates anything —
    // this tool inherits that fail-closed guard for free and does not need a
    // second call here. A GateFailedError propagates as a tool execution error.
