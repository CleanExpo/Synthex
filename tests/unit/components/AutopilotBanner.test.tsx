...
describe('AutopilotBanner', () => {
  ...
  describe('Step indicator logic', () => {
    ...
    it('should route to /dashboard/platforms on platform step', () => {
      const isPlatformStep = true;
      const href = isPlatformStep ? '/dashboard/platforms' : '/dashboard/autonomous';
  ...
  describe('Props interface', () => {
    it('should accept all optional props', () => {
      const props: AutopilotBannerProps = { hasNoPlatforms: true, autopilotInactive: false, className: 'mt-4' };
  ...
  describe('Design system compliance', () => {
    ...
    it('should not reference cyan, green, or blue design tokens', () => {
      const classes = ['border-amber-500/20','bg-amber-500/[0.04]','text-amber-500','bg-amber-500/10','text-amber-400'];
  ...
  describe('Copy content', () => {
    ...
    it('platform description should mention Synthex', () => {
      const d = 'Connect Twitter, LinkedIn, Instagram or any other platform so Synthex can begin publishing and tracking your content automatically.';
      expect(d).toContain('Synthex');
    });

    it('autopilot description should mention AI', () => {
      const d = 'Autopilot uses AI to research trending topics, generate posts, and schedule them for peak engagement - hands-free.';
