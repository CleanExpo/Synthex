...
[25/05/2026] DECISION: Agent stack Phase 0–2 shipped in-repo (SYN-988) — restored CLAUDE.md UTF-8, hooks via `node .cursor/hooks/pre-bash-validate.cjs`, `agent-stack.mdc`, inventory + CI merge docs | REASON: corrupted CLAUDE.md + invalid hook JSON blocked agent shell | ALTERNATIVES REJECTED: full gstack reinstall, disabling hooks entirely
