...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Real-time WebSocket integration for notifications and live updates.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WebSocketDemo: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'Interactive WebSocket demo showing connection management, real-time notifications, and channel subscriptions.',
      },
    },
  },
};
    ...
    <WebSocketProvider showConnectionStatus={true} autoConnect={true}>
      <div className="p-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          This story demonstrates the connection status indicator in the
          top-right corner. The indicator shows the current WebSocket connection
          state and provides a reconnect button when disconnected.
        </p>
        <div className="bg-muted p-4 rounded-lg">
          <h3 className="font-semibold mb-2">Status Indicators:</h3>
          <ul className="space-y-1 text-sm">
            <li>
              <strong>Green dot:</strong> Connected
            </li>
            <li>
              <strong>Yellow dot:</strong> Connecting
            </li>
            <li>
              <strong>Red dot:</strong> Disconnected
            </li>
          </ul>
        </div>
      </div>
