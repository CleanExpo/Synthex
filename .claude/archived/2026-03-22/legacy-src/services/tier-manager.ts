...
export class TierManager {
  ...
  static getUpgradeSuggestion(
    ...
    if (
      usage.platforms &&
      limits.platforms !== 'unlimited' &&
      usage.platforms >= limits.platforms * 0.8
    ) {
    ...
    if (
      usage.postsPerMonth &&
      limits.postsPerMonth !== 'unlimited' &&
      usage.postsPerMonth >= limits.postsPerMonth * 0.8
    ) {
    ...
    if (
      usage.aiGenerations &&
      limits.aiGenerations !== 'unlimited' &&
      usage.aiGenerations >= limits.aiGenerations * 0.8
    ) {
