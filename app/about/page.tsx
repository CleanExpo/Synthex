          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <GlowCard key={index} className="p-6 text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-orange-500 bg-clip-text text-transparent mb-2">
                  {stat.value}
                </div>
          ...
          <div className="bg-charcoal-800/60 border border-white/[0.06] backdrop-blur-sm rounded-2xl p-12">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <Link href="/signup">
                  <Button className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-500 hover:to-orange-500 text-white shadow-lg shadow-orange-500/25">
                    Start for Free
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-orange-500/10 rounded-2xl" />
                <div className="relative p-8">
                  <Brain className="w-full h-64 text-orange-500/30" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-charcoal-800/60 border border-white/[0.06] backdrop-blur-sm rounded-xl p-6 text-center hover:scale-105 hover:border-orange-500/30 transition-all duration-300"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <GlowCard key={index} className="p-6 flex flex-col">
                <div className="w-20 h-20 bg-gradient-to-br from-orange-500/20 to-orange-500/10 border border-orange-500/20 rounded-full mx-auto mb-4 flex items-center justify-center">
                ...
                <p className="text-orange-500 text-center text-sm mb-4">
                  {member.role}
                </p>
            ...
            {milestones.map((milestone, index) => (
              <div key={index} className="flex gap-4 mb-8">
                ...
                <div className="flex-grow">
                  <div className="bg-charcoal-800/60 border border-white/[0.06] backdrop-blur-sm p-4 rounded-lg hover:border-orange-500/30 transition-colors">
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center gap-4 flex-wrap">
                <Link href="/contact?subject=careers">
                  <Button className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-500 hover:to-orange-500 text-white px-8 py-3 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all">
                    View Open Roles
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </Button>
                </Link>
                <Link href="/signup">
                  <Button
                    variant="outline"
                    className="border-orange-500/50 text-orange-500 hover:bg-orange-500/10 hover:border-orange-500 px-8 py-3 transition-all"
                  >
