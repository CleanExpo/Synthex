...
export default function AboutPage() {
  return (
    <MarketingLayout currentPage="about">
          ...
          <div className="bg-charcoal-800/60 border border-white/[0.06] backdrop-blur-sm rounded-2xl p-12">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <Link href="/signup">
                  <Button className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-500 hover:to-amber-500 text-white shadow-lg shadow-amber-500/25">
                    Start for Free
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500/20 to-amber-500/10 rounded-2xl" />
                <div className="relative p-8">
                  <Brain className="w-full h-64 text-amber-500/30" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map((member, index) => (
              <GlowCard key={index} className="p-6 flex flex-col">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-500/20 to-amber-500/10 border border-amber-500/20 rounded-full mx-auto mb-4 flex items-center justify-center">
                ...
                <p className="text-amber-500 text-center text-sm mb-4">
                  {member.role}
                </p>
                <p className="text-gray-400 text-sm text-center mb-5 flex-grow">
                  {member.bio}
                </p>
                <blockquote className="text-gray-300 text-sm text-center italic border-t border-amber-500/10 pt-4">
            ...
            {milestones.map((milestone, index) => (
              <div key={index} className="flex gap-4 mb-8">
                <div className="flex-shrink-0">
                  <div className="w-4 h-4 bg-amber-500 rounded-full mt-1 shadow-lg shadow-amber-500/50" />
                  {index < milestones.length - 1 && (
                    <div className="w-0.5 h-20 bg-gradient-to-b from-amber-500 to-amber-500/30 ml-1.5 mt-1" />
                  )}
                </div>
      ...
      <section className="py-20 md:py-28 px-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-charcoal-800 border border-amber-500/20 backdrop-blur-sm rounded-2xl p-12 text-center relative overflow-hidden">
            {/* Glow effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-amber-500/5 via-amber-500/10 to-amber-500/5 pointer-events-none" />
            <div className="relative z-10">
              ...
              <div className="flex justify-center gap-4 flex-wrap">
                <Link href="/contact?subject=careers">
                  <Button className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-500 hover:to-amber-500 text-white px-8 py-3 shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-all">
                    View Open Roles
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </Button>
                </Link>
                <Link href="/signup">
                  <Button
                    variant="outline"
                    className="border-amber-500/50 text-amber-500 hover:bg-amber-500/10 hover:border-amber-500 px-8 py-3 transition-all"
                  >
