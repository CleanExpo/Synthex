...
const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt:
      'Discover the latest AI trends transforming how businesses approach social media marketing, from predictive analytics to automated content generation.',
    author: 'Sarah Chen',
    date: '2025-01-10',
    readTime: '7 min read',
    category: 'AI Trends',
  ...
  },
  {
    ...
    excerpt:
      'Learn the psychological triggers and data-driven strategies that make content go viral across different social platforms.',
  ...
  },
  {
    ...
    excerpt:
      'Deep dive into how each social media algorithm works and how to optimize your content for maximum reach on each platform.',
  ...
  },
  {
    ...
    excerpt:
      'Explore the cognitive biases and behavioral patterns that drive social media engagement and how to leverage them ethically.',
  ...
  },
  {
    ...
    excerpt:
      'A detailed breakdown of how a startup used Synthex to grow their social media presence exponentially in just three months.',
    author: 'Alex Turner',
    date: '2024-12-28',
    readTime: '8 min read',
    category: 'Case Study',
  ...
  },
  {
    ...
    excerpt:
      'Learn how to create and optimize content calendars based on engagement data and audience behavior patterns.',
    author: 'Lisa Wang',
    date: '2024-12-25',
    readTime: '9 min read',
    category: 'Planning',
        ...
        <div className="container mx-auto">
          <Card className="bg-surface-base/80 backdrop-blur-md border border-amber-500/20 p-12 text-center">
            ...
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
              Get weekly tips, strategies, and updates on AI-powered social
              media marketing delivered to your inbox.
            </p>
