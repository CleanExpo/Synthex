...
import { Sparkles, Shield, Lock, Eye, Database, Globe, Mail, CheckCircle } from '@/components/icons';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-cyan-900/20 to-gray-900">
      ...
      <section className="pt-32 pb-12 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-gray-400 mt-4">Last updated: January 11, 2025</p>
        </div>
      </section>
      ...
      <section className="px-6 pb-20">
        <div className="container mx-auto">
          <Card className="modern-skeu p-12 text-center max-w-3xl mx-auto">
