...
const openPositions: Job[] = [
  {
    ...
    level: 'Senior',
    description:
      'Build and scale our AI-powered platform using Next.js, TypeScript, and Python.',
    requirements: [
      '5+ years experience',
      'React/Next.js expertise',
      'Python/AI experience',
  ...
  },
  {
    ...
    level: 'Senior',
    description:
      'Develop and optimize ML models for content generation and pattern analysis.',
    requirements: [
  ...
  },
  {
    ...
    level: 'Mid-Senior',
    description:
      'Design intuitive interfaces for our AI-powered marketing platform.',
    requirements: [
  ...
  },
  {
    ...
    level: 'Mid',
    description:
      'Help our customers achieve success with Synthex and drive retention.',
    requirements: [
...
const benefits = [
  ...
  },
  {
    icon: Users,
    title: 'Team Retreats',
    description: 'Quarterly in-person gatherings',
  },
];
...
export default function CareersPage() {
  ...
  return (
    <MarketingLayout currentPage="careers">
      ...
      <section className="pt-12 pb-20 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            We're looking for passionate individuals who want to democratize
            AI-powered marketing and help millions of creators succeed.
          </p>
          <Button
            onClick={() =>
              document
      ...
      <section className="px-6 pb-20">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="bg-surface-base/80 border-orange-500/10 p-6 text-center">
              <Rocket className="w-12 h-12 text-orange-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-white mb-2">
                Massive Impact
              </h3>
              <p className="text-gray-400">
                Help millions of creators and businesses succeed with AI-powered
                tools.
              </p>
            </Card>
            <Card className="bg-surface-base/80 border-orange-500/10 p-6 text-center">
              ...
              <p className="text-gray-400">
                Join a fast-growing startup with 10x growth trajectory and
                unlimited potential.
              </p>
            </Card>
            <Card className="bg-surface-base/80 border-orange-500/10 p-6 text-center">
              ...
              <p className="text-gray-400">
                Work with the latest AI/ML technologies and shape the future of
                marketing.
              </p>
            </Card>
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {benefits.map((benefit, index) => (
              <Card
                key={index}
                className="bg-surface-base/80 border-orange-500/10 p-6 hover:scale-105 transition-transform"
              >
                <benefit.icon className="w-10 h-10 text-orange-400 mb-3" />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-300 mb-6">
                  At Synthex, we believe in building a culture where everyone
                  can do their best work, grow professionally, and have fun
                  along the way.
                </p>
              ...
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-orange-400/20 rounded-2xl"></div>
        ...
        <div className="container mx-auto">
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {filteredJobs.map(job => (
              <Card
                key={job.id}
                className="bg-surface-base/80 border-orange-500/10 p-6 hover:shadow-xl transition-all"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex-grow">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      ...
                      <span className="px-3 py-1 bg-orange-500/10 text-orange-300 text-xs rounded-full">
                        {job.location}
                      </span>
                      <span className="px-3 py-1 bg-orange-500/10 text-orange-300 text-xs rounded-full">
                        {job.type}
      ...
      <section className="px-6 pb-20">
        <div className="container mx-auto">
          <Card className="bg-surface-base/80 border-orange-500/10 p-12 text-center">
