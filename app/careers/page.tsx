...
export default function CareersPage() {
  ...
  return (
    <MarketingLayout currentPage="careers">
      ...
      <section className="pt-12 pb-20 px-6">
        <div className="container mx-auto text-center">
          ...
          <Button
            ...
            className="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-8 py-3"
          >
            View Open Positions
      ...
      <section className="px-6 pb-20">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="bg-surface-base/80 border-amber-500/10 p-6 text-center">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {benefits.map((benefit, index) => (
              <Card
                key={index}
                className="bg-surface-base/80 border-amber-500/10 p-6 hover:scale-105 transition-transform"
              >
                <benefit.icon className="w-10 h-10 text-amber-400 mb-3" />
        ...
        <div className="container mx-auto">
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {filteredJobs.map(job => (
              <Card
                key={job.id}
                className="bg-surface-base/80 border-amber-500/10 p-6 hover:shadow-xl transition-all"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <Button className="bg-gradient-to-r from-amber-500 to-amber-600 text-white whitespace-nowrap">
                    Apply Now
                    <ArrowRight className="ml-2 w-4 h-4" />
                  </Button>
                </div>
      ...
      <section className="px-6 pb-20">
        <div className="container mx-auto">
          <Card className="bg-surface-base/80 border-amber-500/10 p-12 text-center">
