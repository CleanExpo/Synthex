...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      'Synthex analyzes your existing content, including posts, captions, and responses. Our AI identifies patterns in your tone, vocabulary, and style to create a unique brand persona that maintains consistency across all generated content.',
    category: 'AI & Features',
  },
  {
    question: 'Which social media platforms does Synthex support?',
    answer:
      'Synthex currently supports Twitter/X, LinkedIn, Instagram, TikTok, Facebook, YouTube, and Pinterest. We continuously add new platforms based on user demand.',
    category: 'Platforms',
  },
  {
    question: 'Can I edit AI-generated content before posting?',
    answer:
      'Absolutely! All AI-generated content goes through a review stage where you can edit, refine, or regenerate content. You have full control over what gets published.',
    category: 'Content',
  },
  {
    question: 'How does the viral pattern analysis work?',
    answer:
      'Our AI analyzes millions of posts daily to identify engagement patterns, trending topics, and viral triggers specific to your industry and audience. It then applies these insights to optimize your content.',
    category: 'AI & Features',
  },
  {
    question: 'What happens if I exceed my monthly post limit?',
    answer:
      "You can either upgrade to a higher plan or purchase additional posts as needed. We'll notify you when you're approaching your limit.",
    category: 'Billing',
  },
  {
    question: 'Is my data secure with Synthex?',
    answer:
      "Yes, we use enterprise-grade encryption for all data. Your content and analytics are stored securely and never shared with third parties. We're SOC 2 compliant.",
    category: 'Security',
  },
  {
    question: 'Can I collaborate with my team on Synthex?',
    answer:
      'Yes! Our Pro and Enterprise plans include team collaboration features with role-based permissions, approval workflows, and shared content libraries.',
    category: 'Team',
  },
  {
    question: 'How do I connect my social media accounts?',
    answer:
      'Navigate to Settings > Connected Accounts and follow the OAuth authentication process for each platform. The connection is secure and can be revoked anytime.',
    category: 'Setup',
  },
];
      ...
      <section className="pt-12 pb-12 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Get instant answers, explore our documentation, or reach out to our
            support team
          </p>
            ...
            {filteredFAQs.map((faq, index) => (
              ...
              >
                <button
                  ...
                  className="w-full px-6 py-4 flex items-center justify-between text-left hover:bg-[#FF6B35]/5 transition-colors"
                >
      ...
      <section className="px-6 pb-12">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="bg-surface-base/80 border-[#FF6B35]/10 p-6">
              <Zap className="w-10 h-10 text-[#FF9A6C] mb-4" />
            ...
            <Card className="bg-surface-base/80 border-[#FF6B35]/10 p-6">
              <Settings className="w-10 h-10 text-[#FF9A6C] mb-4" />
              <h3 className="text-xl font-semibold text-white mb-3">
                Features & Tools
              </h3>
              <ul className="space-y-2">
            ...
            <Card className="bg-surface-base/80 border-[#FF6B35]/10 p-6">
              <CreditCard className="w-10 h-10 text-[#FF9A6C] mb-4" />
              <h3 className="text-xl font-semibold text-white mb-3">
                Billing & Plans
              </h3>
              <ul className="space-y-2">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-300 mb-6">
                  Our support team is available 24/7 to help you get the most
                  out of Synthex.
                </p>
              ...
              <div>
                <form className="space-y-4">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-surface-base/80 border border-[#FF6B35]/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#FF9A6C]"
                  />
                  <input
                    type="email"
