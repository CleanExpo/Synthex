            ...
            <section className="space-y-12">
              <div>
                ...
                <p className="text-white/60">
                  OLED-optimized dark theme with vibrant accents
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  <ColorSwatch
                    name="Primary"
                    color="#ffb87b"
                    desc="Orange/Amber - AI signature"
                  />
                  <ColorSwatch
                    name="Primary Light"
                    color="#ffdcc2"
                ...
                <div className="space-y-4">
                  <div className="rounded-xl border border-orange-500/10 bg-surface-dark/50 p-6">
                    ...
                    <p className="text-lg leading-relaxed text-gray-300">
                      Generate viral content with AI, analyze engagement
                      patterns, and automate your social media presence across
                      all platforms.
                    </p>
                  </div>
                  <div className="rounded-xl border border-orange-500/10 bg-surface-dark/50 p-6">
                    ...
                    <p className="text-base leading-normal text-gray-400">
                      Our platform uses advanced machine learning to understand
                      your brand voice and create content that resonates with
                      your audience.
                    </p>
                  </div>
                  <div className="rounded-xl border border-orange-500/10 bg-surface-dark/50 p-6">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  ...
                  <div className="rounded-xl border border-orange-500/10 bg-surface-base p-6 transition-all hover:border-orange-500/30">
                    ...
                    <p className="text-sm text-gray-400">
                      Standard card with subtle hover effect and clean borders.
                    </p>
                  </div>
                  ...
                  <div className="group relative rounded-xl border border-orange-500/30 bg-orange-500/5 p-6 shadow-lg shadow-orange-500/10 backdrop-blur-xl transition-all hover:-translate-y-1 hover:border-orange-500/50 hover:shadow-orange-500/20">
                    ...
                    <p className="text-sm text-gray-400">
                      Enhanced with glow effect and lift animation on hover.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'effects' && (
            <section className="space-y-12">
              <div>
                ...
                <p className="text-white/60">
                  Visual effects inspired by AI/tech aesthetic
                </p>
              </div>
                  ...
                  <div className="relative flex h-full items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="mt-2 text-gray-400">
                        Ambient floating particles with grid overlay
                      </p>
                    </div>
                  </div>
                </div>
...
function StatCard({
  ...
  return (
    <div className="rounded-xl border border-orange-500/10 bg-orange-500/5 p-6 backdrop-blur-lg">
      ...
      <p
        className={`mt-1 flex items-center gap-1 text-sm font-medium ${positive ? 'text-green-400' : 'text-red-400'}`}
      >
        {positive ? '↑' : '↓'} {change}
      </p>
    </div>
