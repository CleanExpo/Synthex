  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="mx-auto max-w-7xl px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="rounded-full bg-white/10 px-2 py-0.5 text-xs font-medium">v4.0</span>
            </div>
          ...
          <section className="space-y-12">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                <ColorSwatch name="Primary" color="#8B5CF6" desc="Violet - AI signature" />
                <ColorSwatch name="Primary Light" color="#A78BFA" desc="Hover states" />
                <ColorSwatch name="Secondary" color="#06B6D4" desc="Cyan - Data" />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 md:grid-cols-6 lg:grid-cols-12">
                <ColorChip color="#000000" name="Black" />
                <ColorChip color="#0A0A0C" name="950" />
                <ColorChip color="#111115" name="900" />
                <ColorChip color="#1F1F26" name="800" />
                <ColorChip color="#373741" name="700" />
                <ColorChip color="#52525F" name="600" />
                <ColorChip color="#737382" name="500" />
                <ColorChip color="#9C9CAA" name="400" />
                <ColorChip color="#C4C4D0" name="300" />
                <ColorChip color="#E1E1E8" name="200" />
                <ColorChip color="#F1F1F4" name="100" />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
                {[3, 6, 10, 14, 18].map((opacity) => (
                  <div
                    key={opacity}
                    className="relative overflow-hidden rounded-xl border border-white/10 p-6"
        ...
        {activeTab === 'typography' && (
          <section className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 rounded-2xl border border-white/10 bg-white/[0.02] p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
                <h1 className="bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-6xl font-bold tracking-tight text-transparent">
                  Next-Gen Marketing
                </h1>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                <span className="rounded-lg bg-black px-6 py-3 text-3xl font-black uppercase tracking-tight text-white">
                  AI Marketing
                </span>
                <span className="rounded-lg bg-white px-6 py-3 text-3xl font-black uppercase tracking-tight text-black">
                  Agency Guide
                </span>
                <span className="rounded-lg bg-gradient-to-r from-violet-600 to-cyan-500 px-6 py-3 text-3xl font-black uppercase tracking-tight text-white">
                  SYNTHEX
                </span>
              </div>
            </div>
        ...
        {activeTab === 'components' && (
          <section className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-8">
                <div className="flex flex-wrap gap-4">
                  <button className="rounded-lg bg-gradient-to-r from-violet-600 to-violet-700 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-500/25 transition-all hover:from-violet-500 hover:to-violet-600 hover:shadow-violet-500/40">
                    Primary Button
                  </button>
                  <button className="rounded-lg border border-white/10 bg-white/5 px-6 py-3 text-sm font-semibold text-white backdrop-blur-md transition-all hover:bg-white/10">
                    Secondary
                  </button>
                  <button className="rounded-lg border border-white/20 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-white/5">
                    Outline
                  </button>
                  <button className="rounded-lg px-6 py-3 text-sm font-semibold text-gray-400 transition-all hover:bg-white/5 hover:text-white">
                    Ghost
                  </button>
                ...
                <div className="mt-6 flex flex-wrap gap-4">
                  <button className="rounded-full bg-gradient-to-r from-violet-600 to-violet-700 px-6 py-3 text-sm font-semibold text-white">
                    Pill Button
                  </button>
                  <button className="rounded-lg bg-violet-600 px-4 py-2 text-xs font-semibold text-white">
                    Small
                  </button>
                  <button className="rounded-lg bg-violet-600 px-8 py-4 text-base font-semibold text-white">
                    Large
                  </button>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap gap-3 rounded-2xl border border-white/10 bg-white/[0.02] p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {/* Basic Card */}
                <div className="rounded-xl border border-white/10 bg-gray-900 p-6 transition-all hover:border-white/20">
                ...
                {/* Glass Card */}
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl transition-all hover:border-white/20 hover:bg-white/10">
                ...
                {/* Premium Card */}
                <div className="group relative rounded-xl border border-violet-500/30 bg-white/5 p-6 shadow-lg shadow-violet-500/10 backdrop-blur-xl transition-all hover:-translate-y-1 hover:border-violet-500/50 hover:shadow-violet-500/20">
                  <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-violet-500 to-fuchsia-500">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 rounded-2xl border border-white/10 bg-white/[0.02] p-8 md:grid-cols-2">
                <div>
                  <label className="mb-2 block text-sm font-medium text-gray-400">Standard Input</label>
                  <input
                    type="text"
                    placeholder="Enter your email..."
                    className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder-gray-500 transition-all focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/5 px-5 py-4 text-base text-white placeholder-gray-500 transition-all focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-6 rounded-2xl border border-white/10 bg-white/[0.02] p-8">
                <div className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white/20 bg-gradient-to-br from-violet-500 to-cyan-500 text-xs font-bold">
                  SM
                </div>
                <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-white/20 bg-gradient-to-br from-fuchsia-500 to-violet-500 text-sm font-bold">
                  MD
                </div>
                <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-white/20 bg-gradient-to-br from-cyan-500 to-blue-500 text-base font-bold">
                  LG
                </div>
                <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-white/20 bg-gradient-to-br from-amber-500 to-orange-500 text-lg font-bold">
                  XL
                </div>
                {/* Avatar Group */}
                <div className="flex -space-x-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-gray-900 bg-violet-500 text-xs font-bold">JD</div>
                  <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-gray-900 bg-cyan-500 text-xs font-bold">AK</div>
                  <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-gray-900 bg-fuchsia-500 text-xs font-bold">MR</div>
                  <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-gray-900 bg-white/20 text-xs font-bold">+5</div>
                </div>
              </div>
            </div>
          </section>
        ...
        {activeTab === 'effects' && (
          <section className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="relative h-80 overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-gray-900 to-black">
                {/* Particles */}
                <div className="absolute inset-0">
                  {[...Array(30)].map((_, i) => (
                    <div
                      key={i}
                      className="absolute h-1 w-1 animate-pulse rounded-full bg-white/40"
                      style={{
                ...
                <div className="relative flex h-full items-center justify-center">
                  <div className="text-center">
                    <h3 className="bg-gradient-to-r from-white via-gray-300 to-white bg-clip-text text-4xl font-bold text-transparent">
                      Particle Field
                    </h3>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="rounded-xl border border-violet-500/30 bg-white/5 p-8 text-center shadow-lg shadow-violet-500/20">
                  <span className="text-sm font-medium text-violet-300">Primary Glow</span>
                </div>
                <div className="rounded-xl border border-cyan-500/30 bg-white/5 p-8 text-center shadow-lg shadow-cyan-500/20">
                  <span className="text-sm font-medium text-cyan-300">Secondary Glow</span>
                </div>
                <div className="rounded-xl border border-red-500/30 bg-white/5 p-8 text-center shadow-lg shadow-red-500/20">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="relative h-48 overflow-hidden rounded-xl">
                  ...
                  <div
                    ...
                    style={{
                      background: 'radial-gradient(ellipse 80% 50% at 50% -20%, rgba(139, 92, 246, 0.3), transparent 70%)',
                    }}
                  />
                  <div className="relative flex h-full items-center justify-center">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-4">
                <div className="flex flex-col items-center gap-4 rounded-xl border border-white/10 bg-white/[0.02] p-6">
                  <div className="h-12 w-12 animate-pulse rounded-lg bg-violet-500/50" />
                  <span className="text-xs text-gray-400">Pulse</span>
                </div>
                <div className="flex flex-col items-center gap-4 rounded-xl border border-white/10 bg-white/[0.02] p-6">
                  <div className="h-12 w-12 animate-bounce rounded-lg bg-cyan-500/50" />
                  <span className="text-xs text-gray-400">Bounce</span>
                </div>
                <div className="flex flex-col items-center gap-4 rounded-xl border border-white/10 bg-white/[0.02] p-6">
                  <div className="h-12 w-12 animate-spin rounded-lg border-2 border-fuchsia-500/50 border-t-fuchsia-500" />
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <div className="cursor-pointer rounded-xl border border-white/10 bg-white/5 p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-black/50">
                  <span className="text-sm font-medium">Lift Effect</span>
                </div>
                <div className="cursor-pointer rounded-xl border border-white/10 bg-white/5 p-8 text-center transition-all duration-300 hover:scale-105">
                  <span className="text-sm font-medium">Scale Effect</span>
                </div>
                <div className="cursor-pointer rounded-xl border border-white/10 bg-white/5 p-8 text-center transition-all duration-300 hover:border-violet-500/50 hover:shadow-lg hover:shadow-violet-500/20">
      ...
      <footer className="border-t border-white/10 py-8 text-center text-sm text-gray-500">
        SYNTHEX Design System v4.0 - Built for AI Marketing Excellence
      </footer>
    </div>
  );
}
...
function ColorChip({ color, name, light }: { color: string; name: string; light?: boolean }) {
  return (
    <div className="text-center">
      <div
        className="mx-auto mb-1 h-10 w-10 rounded-lg border border-white/10"
