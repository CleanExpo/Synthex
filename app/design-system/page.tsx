          ...
          <div className="mx-auto max-w-7xl px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="rounded-full bg-orange-500/20 px-2 py-0.5 text-xs font-medium text-orange-300">v4.0</span>
              </div>
            ...
            <section className="space-y-12">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  <ColorSwatch name="Primary" color="#ffb87b" desc="Orange/Amber - AI signature" />
                  <ColorSwatch name="Primary Light" color="#ffdcc2" desc="Hover states" />
                  <ColorSwatch name="Primary Deep" color="#ff8f00" desc="Deep Orange - Depth" />
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2 md:grid-cols-6 lg:grid-cols-12">
                  <ColorChip color="#050505" name="Navy" />
                  <ColorChip color="#111111" name="950" />
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
                  {[3, 6, 10, 14, 18].map((opacity) => (
                    <div
                      ...
                      style={{ background: `rgba(255, 184, 123, ${opacity / 100})` }}
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  ...
                  <ColorSwatch name="Info" color="#ffb87b" desc="Informational" />
                </div>
              </div>
            </section>
          )}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-6 rounded-2xl border border-orange-500/10 bg-surface-dark/50 p-8">
                  ...
                  <div className="flex -space-x-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-surface-dark bg-orange-500 text-xs font-bold">JD</div>
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-surface-dark bg-orange-600 text-xs font-bold">AK</div>
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-surface-dark bg-orange-400 text-xs font-bold">MR</div>
                    <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-surface-dark bg-orange-500/30 text-xs font-bold">+5</div>
                  </div>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  <div className="rounded-xl border border-orange-500/30 bg-orange-500/5 p-8 text-center shadow-lg shadow-orange-500/20">
                    <span className="text-sm font-medium text-orange-300">Primary Glow</span>
                  </div>
                  <div className="rounded-xl border border-orange-400/30 bg-orange-400/5 p-8 text-center shadow-lg shadow-orange-400/20">
                    <span className="text-sm font-medium text-orange-300">Secondary Glow</span>
                  </div>
