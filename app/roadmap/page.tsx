...
const quarters = [
  ...
  },
  {
    ...
    items: [
      {
        title: 'Advanced Viral Pattern Analysis',
        status: 'completed',
        icon: Rocket,
      },
      {
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our commitment to continuous innovation and delivering the most
          ...
          <div className="mt-16">
            <Card className="bg-surface-base/80 border-orange-500/10 p-8 text-center">
              ...
              <p className="text-gray-300 mb-6">
                We're always looking for ways to improve Synthex. Share your
