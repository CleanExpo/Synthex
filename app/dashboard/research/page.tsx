        ...
        <Card className="bg-surface-base/80 border border-cyan-500/10">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-white/70 flex items-center gap-2">
              <RefreshCw className="h-4 w-4 text-cyan-400/60" />
              Research Runs
            </CardTitle>
          </CardHeader>
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-white/70 flex items-center gap-2">
                ...
                Live Insights
                {insights.length > 0 && (
                  <span className="text-[10px] px-1.5 py-0.5 rounded-sm bg-cyan-500/10 text-cyan-400/70 ml-1">
                    {insights.length}
                  </span>
                )}
              </CardTitle>
              {availablePlatforms.length > 0 && (
                <div className="flex items-center gap-1.5">
                  ...
                  <select
                    ...
                    className="text-xs bg-white/[0.04] border border-white/[0.08] text-white/50 rounded-sm px-2 py-0.5 focus:outline-none focus:border-cyan-500/30"
                  >
            ...
            {insightsLoading ? (
              ...
              <div className="space-y-2 max-h-72 overflow-y-auto pr-1">
                {filteredInsights.map(insight => (
                  ...
                  >
                    <Globe className="h-3 w-3 text-cyan-400/40 shrink-0 mt-0.5" />
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          ...
                          {report.sasScore !== null && (
                            <Badge
                              className={`${report.sasScore >= 7 ? 'bg-emerald-500/20 text-emerald-400' : 'bg-amber-500/20 text-amber-400'}`}
                            >
