...
function ReadinessCheckTab({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Results */}
      {result && !loading && <ReadinessResults result={result} />}
    </div>
  );
}
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              <span
                className={`text-3xl font-bold ${getScoreColor(result.score.overall)}`}
              >
            ...
            <div>
              ...
              <span
                className={`inline-block mt-1 px-3 py-1 text-sm font-medium rounded-full border ${tierBadge.className}`}
              >
                {tierBadge.label}
              </span>
            </div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {DIMENSION_CONFIG.map(dim => {
              const score =
                result.score[dim.key as keyof typeof result.score] || 0;
              const Icon = dim.icon;
              return (
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {Object.entries(result.platformReadiness).map(
              ([platform, ready]) => (
                <div
                  key={platform}
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-sm font-medium ${ready ? 'text-emerald-400' : 'text-red-400'}`}
                    >
                      {platform
                        .replace('_', ' ')
          ...
          {passages.map((passage, idx) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span
                  className={`px-2 py-1 text-xs font-medium rounded ${getScoreBg(passage.score)} ${getScoreColor(passage.score)}`}
                >
                  Score: {passage.score}
                </span>
...
function TrendsTab({
  ...
  const lineConfig = [
    { key: 'overall', label: 'Overall', color: '#ffb87b' },
    { key: 'citability', label: 'Citability', color: '#ffdcc2' },
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {lineConfig.map(line => (
            <Button
              ...
              style={{
                borderColor: visibleLines[line.key as keyof typeof visibleLines]
                  ? line.color
                  : undefined,
                color: visibleLines[line.key as keyof typeof visibleLines]
                  ? line.color
                  : undefined,
              }}
            >
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <span
                        className={`text-lg font-bold ${getScoreColor(entry.overallScore)}`}
                      >
                        {entry.overallScore}
                      </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                      {[
                        ...
                        >
                          ...
                          <p
                            className={`text-lg font-semibold ${getScoreColor(dim.value)}`}
                          >
                            {dim.value}
                          </p>
                        </div>
