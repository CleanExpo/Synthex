  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Page score: ${data.analysis.score}/100`,
      });
    } catch (error) {
      toast({
          ...
          <div className="space-y-6">
                ...
                {result.headings.hasMultipleH1 && (
                  <div className="flex items-center gap-2 p-3 bg-red-500/10 border border-red-500/20 rounded-lg mb-4">
                    ...
                    <p className="text-red-300 text-sm">
                      Multiple H1 tags detected — use only one per page
                    </p>
                  </div>
                )}
                    ...
                    return (
                      <div key={tag} className="space-y-1">
                        ...
                        {headings.slice(0, 5).map((h, i) => (
                          <p
                            key={i}
                            className={`text-gray-300 text-sm ${tag === 'h1' ? '' : `ml-${Math.min(parseInt(tag[1]) * 2, 10)}`}`}
                          >
                            {h}
                          </p>
                        ))}
              ...
              <Card className="bg-surface-base/80 backdrop-blur-xl border border-orange-500/10">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex justify-between p-3 bg-white/5 rounded-lg">
                    ...
                    <span
                      className={`font-medium ${result.images.missingAlt > 0 ? 'text-red-400' : 'text-green-400'}`}
                    >
            ...
            <Card className="bg-surface-base/80 backdrop-blur-xl border border-orange-500/10">
              ...
              <CardContent>
                ...
                result.schema.types[0] !== 'None detected' ? (
                  ...
                  <div className="flex items-center gap-2 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                    ...
                    <p className="text-yellow-300 text-sm">
                      No structured data detected — consider adding JSON-LD
                      schema
                    </p>
                  </div>
                )}
