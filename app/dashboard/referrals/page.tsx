    ...
    return (
      <div className="max-w-3xl mx-auto">
        <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 text-center space-y-4">
          ...
          <button
            onClick={() => mutate()}
            className="px-4 py-2 text-xs rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 hover:bg-cyan-500/20 transition-colors"
          >
            Retry
          </button>
        </div>
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 space-y-3">
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 min-w-0 font-mono text-sm text-cyan-300 bg-black/30 border border-white/10 rounded-lg px-3 py-2.5 truncate">
            {referralLink}
          </div>
          <button
            onClick={handleCopy}
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 space-y-3">
        ...
        <form onSubmit={handleInvite} className="flex items-center gap-2">
          <input
            ...
            required
            className="flex-1 min-w-0 text-sm bg-black/30 border border-white/10 rounded-lg px-3 py-2.5 text-white placeholder:text-slate-600 focus:outline-none focus:border-cyan-500/40 transition-colors"
          />
          <button
            type="submit"
            disabled={inviting}
            className="flex-shrink-0 flex items-center gap-2 px-4 py-2.5 rounded-lg text-xs font-medium bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 hover:bg-cyan-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
