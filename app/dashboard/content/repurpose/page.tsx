          ...
          {sourceType === 'text' ? (
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full rounded-md px-3 py-2.5 text-sm text-white placeholder:text-zinc-600 bg-zinc-800/50 border border-zinc-700/50 focus:outline-none focus:ring-1 focus:ring-orange-500/60 focus:border-orange-500/40 transition-colors resize-none leading-relaxed"
              />
            </div>
          ) : (
            <div className="space-y-1.5">
