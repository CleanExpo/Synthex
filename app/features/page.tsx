    ...
    <MarketingLayout currentPage="features">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm font-semibold text-amber-500 uppercase tracking-widest mb-4">
            Platform Features
          </p>
      ...
      <section className="pb-20 px-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold text-amber-500 uppercase tracking-widest text-center mb-3">
            See It in Action
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="rounded-xl overflow-hidden border border-white/10 bg-white/5 hover:border-amber-500/30 transition-colors"
              >
          ...
          <ContainerStagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <ContainerAnimated animation="bottom">
              <GlowCard className="p-6 h-full">
                <div className="bg-amber-500/10 rounded-lg p-3 w-12 h-12 flex items-center justify-center mb-4">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start text-sm text-gray-300">
                    <CheckCircle2 className="w-4 h-4 text-amber-500 mr-2 mt-0.5 shrink-0" />
          ...
          <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-5 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={platform.name} className="text-center group">
                <GlowCard className="bg-white/5 border border-white/10 rounded-xl p-4 mb-3 hover:border-amber-500/30 transition-colors hover:scale-105 duration-200">
                  <platform.Icon
                    size={32}
      ...
      <section className="py-20 md:py-28 px-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="p-12 text-center bg-gradient-to-r from-amber-500/10 to-amber-600/10 border-amber-500/20 backdrop-blur-xl">
            ...
            <Link href="/signup">
              <Button
                size="lg"
                className="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-10 py-6 text-lg hover:from-amber-600 hover:to-amber-700"
              >
                Start Free Trial
