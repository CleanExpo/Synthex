          ...
          <div className="space-y-6">
            {pricingFaqs.map(faq => (
              <Card
                key={faq.question}
                variant="glass"
                className="p-6 bg-surface-base/80 backdrop-blur-sm border border-amber-500/10 hover:border-amber-500/20 transition-all duration-300"
              >
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <Card
            ...
            className="p-12 text-center bg-gradient-to-r from-amber-500/10 to-amber-600/10 backdrop-blur-sm border border-amber-500/20"
          >
            ...
            <Link href="/signup">
              <Button
                size="lg"
                className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-500 hover:to-amber-500 text-white px-10 py-6 text-lg font-medium shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-all duration-300"
              >
                Get Started Now
              </Button>
            </Link>
