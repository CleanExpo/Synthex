...
const caseStudies = [
  {
    ...
    logo: '🚀',
    challenge:
      'Struggling to maintain consistent social media presence while scaling their startup.',
    solution:
      'Implemented AI persona learning to capture their unique brand voice and automated content generation.',
    results: [
    ...
    quote:
      'Synthex transformed our social media strategy. We went from posting sporadically to having a consistent, engaging presence that actually converts.',
    author: 'Sarah Chen',
    role: 'CEO & Co-founder',
    featured: true,
  },
  {
    ...
    logo: '✨',
    challenge:
      'Needed to scale content production for multiple product launches across platforms.',
    solution:
      'Used viral pattern analysis and smart scheduling to optimize posting times and content types.',
    results: [
    ...
    quote:
      "The AI understands our brand voice perfectly. Our engagement rates have never been higher, and we're reaching audiences we never could before.",
  ...
  },
  {
    ...
    logo: '💪',
    challenge:
      'Solo entrepreneur needed to compete with larger fitness brands on social media.',
    solution:
      'Leveraged AI content generation and multi-platform posting to maintain presence across 6 platforms.',
    results: [
    ...
    quote:
      'As a one-person business, Synthex is like having a full marketing team. I focus on coaching while it handles my entire social presence.',
  ...
  },
  {
    ...
    logo: '🍽️',
    challenge:
      'Managing social media for 12 restaurant locations with limited marketing staff.',
    solution:
      'Implemented team collaboration features with location-specific content automation.',
    results: [
    ...
    quote:
      'We can now maintain unique personalities for each location while ensuring brand consistency. Our local engagement has skyrocketed.',
    author: 'David Park',
  ...
  },
  {
    ...
    logo: '📈',
    challenge:
      'Agency needed to scale client management without proportionally increasing headcount.',
    solution:
      "White-label solution with custom AI training for each client's brand voice.",
    results: [
    ...
    quote:
      'Synthex allowed us to triple our client base without hiring additional staff. The white-label features make it seamlessly ours.',
  ...
  },
  {
    ...
    logo: '🌿',
    challenge:
      'Needed to tell their sustainability story effectively across multiple demographics.',
    solution:
      'Used A/B testing and viral pattern analysis to optimize messaging for different audience segments.',
    results: [
    ...
    quote:
      'The platform helps us communicate our mission authentically. Our community has grown into passionate brand advocates.',
    author: 'Lisa Green',
    role: 'Brand Director',
    featured: false,
  },
    ...
    <MarketingLayout currentPage="case-studies">
      ...
      <section className="pt-12 pb-16 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-3xl mx-auto">
            See how businesses of all sizes are transforming their social media
            presence and achieving remarkable growth with Synthex.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          ...
          <p className="text-gray-500 text-center mb-12 max-w-2xl mx-auto">
            From startups to enterprises, Synthex powers social media success
            everywhere
          </p>
        ...
        <div className="container mx-auto">
          <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/10 backdrop-blur-xl border border-orange-500/20 rounded-2xl p-12 text-center">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses achieving remarkable results with
