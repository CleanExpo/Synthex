  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        description: 'Optimize existing content for engagement',
      },
      {
        method: 'POST',
        path: '/api/ai-content/translate',
        description: 'Translate content to target language',
      },
      {
        method: 'POST',
        path: '/api/ai-content/hashtags',
    ...
    endpoints: [
      {
        ...
        description: 'Get engagement overview metrics',
      },
      {
        method: 'GET',
      ...
      },
      {
        ...
        description: 'Get trending topics and patterns',
      },
    ],
  },
];
      ...
      <section className="pt-12 pb-16 px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-3xl mx-auto">
            Build powerful integrations with the Synthex API. Access our
            AI-powered content generation, scheduling, and analytics
        ...
        <div className="container mx-auto">
          <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/10 backdrop-blur-xl border border-orange-500/20 rounded-2xl p-12 text-center">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Get your API key and start building powerful integrations with
              Synthex.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/signup">
