...
export function CustomErrorPage({
  ...
  const config =
    errorConfigs[statusCode as keyof typeof errorConfigs] || errorConfigs[500];
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <Card variant="glass" className="p-8 text-center">
          ...
          {/* Error message */}
          <p className="text-gray-400 mb-8">{message || config.message}</p>

          {/* Action buttons */}
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            {showRetryButton && (
              <Button onClick={handleRetry} variant="default" className="group">
...
export function NotFoundPage() {
  return <CustomErrorPage statusCode={404} showRetryButton={false} />;
}
...
export function ForbiddenPage() {
  return <CustomErrorPage statusCode={403} showRetryButton={false} />;
}
      ...
      <div className="max-w-md w-full">
        <Card variant="glass" className="p-8 text-center">
          ...
          <p className="text-gray-400 mb-8">
            We're upgrading our systems to serve you better. We'll be back
            online shortly!
          </p>
