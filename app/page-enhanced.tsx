        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold gradient-text-orange heading-serif">Synthex</span>
            </div>
            <div className="flex items-center space-x-6">
              <Link href="/features" className="text-gray-300 hover:text-orange-400 transition body-text">
                Features
              </Link>
              <Link href="/pricing" className="text-gray-300 hover:text-orange-400 transition body-text">
                Pricing
              </Link>
              <Link href="/docs" className="text-gray-300 hover:text-orange-400 transition body-text">
                Docs
              </Link>
              <Link href="/login">
              ...
              <Link href="/signup">
                <Button className="bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-beautiful-md hover:shadow-beautiful-lg transition-all">
      ...
      <section className="pt-32 pb-20 px-6 relative">
        <div className="container mx-auto text-center">
          ...
          <div className="flex justify-center space-x-4 stagger-children">
            <Link href="/signup">
              <Button size="lg" className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-6 text-lg shadow-beautiful-lg shadow-hover-lift btn-ripple">
                Start Free Trial
                <ArrowRight className="ml-2" />
              </Button>
            </Link>
            <Link href="/demo">
              <Button size="lg" variant="outline" className="liquid-glass border-orange-400/20 text-white px-8 py-6 text-lg hover:bg-orange-400/10 shadow-beautiful-md">
                Watch Demo
              </Button>
            </Link>
          </div>
          ...
          <div className="bento-grid bento-grid-3">
            ...
            <Card className="bento-item-wide liquid-glass p-6 scroll-reveal shadow-beautiful-lg shadow-hover-lift">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-orange-400 to-amber-400 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 rounded-full text-xs bg-orange-500/20 text-orange-400 border border-orange-500/30">Twitter/X</span>
                    <span className="px-3 py-1 rounded-full text-xs bg-amber-500/20 text-amber-400 border border-amber-500/30">Instagram</span>
                    <span className="px-3 py-1 rounded-full text-xs bg-teal-500/20 text-orange-400 border border-teal-500/30">TikTok</span>
                    <span className="px-3 py-1 rounded-full text-xs bg-orange-500/20 text-orange-400 border border-orange-500/30">LinkedIn</span>
                  </div>
                </div>
              </div>
            </Card>
        ...
        <div className="container mx-auto">
          <Card className="modern-skeu p-16 text-center scroll-reveal">
            ...
            <div className="flex justify-center space-x-4">
              <Link href="/signup">
                <Button size="lg" className="bg-gradient-to-r from-orange-500 via-teal-500 to-amber-500 text-white px-12 py-7 text-lg shadow-beautiful-xl shadow-hover-lift" data-magnetic>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold gradient-text-orange heading-serif">Synthex</span>
              </div>
              <p className="text-gray-400 body-text">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 body-text">
                <li><Link href="/docs" className="hover:text-orange-400 transition">Documentation</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 body-text">
                ...
                <li><Link href="/privacy" className="hover:text-orange-400 transition">Privacy</Link></li>
