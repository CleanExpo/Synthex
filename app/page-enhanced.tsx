...
export default function EnhancedHomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-amber-900/20 to-gray-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              <Link
                href="/features"
                className="text-gray-300 hover:text-amber-400 transition body-text"
              >
                Features
              </Link>
              <Link
              ...
              <Link href="/signup">
                <Button className="bg-gradient-to-r from-amber-500 to-amber-500 text-white shadow-beautiful-md hover:shadow-beautiful-lg transition-all">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex justify-center space-x-4 stagger-children">
            <Link href="/signup">
              <Button
                size="lg"
                className="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-8 py-6 text-lg shadow-beautiful-lg shadow-hover-lift btn-ripple"
              >
                Start Free Trial
            ...
            <Link href="/demo">
              <Button
                size="lg"
                variant="outline"
                className="liquid-glass border-amber-400/20 text-white px-8 py-6 text-lg hover:bg-amber-400/10 shadow-beautiful-md"
              >
                Watch Demo
              </Button>
            </Link>
        ...
        <div className="container mx-auto">
          ...
          <div className="bento-grid bento-grid-3">
            ...
            <Card className="bento-item-featured liquid-glass p-8 scroll-reveal shadow-beautiful-xl shadow-hover-lift">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center mb-6 shadow-glow-orange">
            ...
            <Card className="bento-item-wide liquid-glass p-6 scroll-reveal shadow-beautiful-lg shadow-hover-lift">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-amber-400 to-amber-400 flex items-center justify-center flex-shrink-0">
