 ...
 *
 * GET /api/pr/press-releases/newsroom/[orgSlug]/[slug] — Public newsroom endpoint (no auth)
 *
 ...
 *
 * NOTE: Moved from /api/pr/press-releases/[orgSlug]/[slug] to avoid Next.js dynamic
 * segment conflict with the sibling /api/pr/press-releases/[id] route.
 *
 * @module app/api/pr/press-releases/newsroom/[orgSlug]/[slug]/route
 */
...
// ─── GET /api/pr/press-releases/newsroom/[orgSlug]/[slug] ─────────────────────
...
export async function GET(_request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('[PR press-releases/newsroom/[orgSlug]/[slug] GET]', error);
