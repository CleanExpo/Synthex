/**
 * AI PM Conversations API
 *
 * GET /api/ai/pm/conversations - List conversations (paginated, newest first)
 * POST /api/ai/pm/conversations - Create new conversation
 *
 ...
 * List user's AI PM conversations, newest first
 */
