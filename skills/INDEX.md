...
### Design (3 skills)
2025-2026 aesthetic, Bento grids, NO Lucide icons, locked design tokens.

| Skill | Priority | Auto-load | Description |
|-------|----------|-----------|-------------|
| **design-system.skill.md** | 1 | ✅ | Locked design tokens (primary #0D9488 teal), 2025-2026 aesthetic (Bento grids, glassmorphism), NO Lucide icons |
...
### Backend (3 skills)
FastAPI, LangGraph, advanced tool use patterns.

| Skill | Priority | Auto-load | Description |
|-------|----------|-----------|-------------|
| **advanced-tool-use.skill.md** | 3 | ❌ | Context-efficient tool management (85% token savings), tool search, deferred loading, Australian context tools |
| **langgraph.skill.md** | 3 | ❌ | LangGraph workflow patterns, multi-agent coordination, state management, Australian context preservation |
| **fastapi.skill.md** | 3 | ❌ | FastAPI patterns, Australian phone/ABN validation, Privacy Act 1988 compliance, en-AU error messages |

---

### Frontend (2 skills)
Next.js 15, React 19, 2025-2026 design system.

| Skill | Priority | Auto-load | Description |
|-------|----------|-----------|-------------|
| **nextjs.skill.md** | 3 | ❌ | Next.js 15 App Router, Server Components, Australian context utilities (formatDateAU, formatCurrencyAUD) |
| **components.skill.md** | 4 | ❌ | Reusable UI components (Bento grids, glassmorphism cards), AI-generated custom icons (NO Lucide) |
...
| **design-system.skill.md** | Design | 2025-2026 aesthetic, NO Lucide icons |
...
| *[Additional skills as needed]* | Various | Domain-specific patterns |
...
- `design-system.skill.md` - 2025-2026 aesthetic
...
*Phase 2 Complete - All 35+ skills migrated with `.skill.md` extension*
