...
| 2026-08-29 | ra    | linkedin_post  | Job-close system for water-damage tradies | `sweep` (founder lock; engine agreed, but stage-2 critic NEVER ran) | DRAFT  | `missing-logo:ra`    | [`ra-job-close-system-2026-08-29-01/`](ra-job-close-system-2026-08-29-01/) — locked, promoted, funnel suite rendered         |
