...
| 2026-08-29 | ra    | linkedin_post  | Job-close system for water-damage tradies | `sweep` (engine recommendation; stage-2 critic NOT run)          | DRAFT  | `missing-logo:ra`    | `.artifacts/design-runs/ra-job-close-system-2026-08-29-01/` — working set only, not promoted (no lock decision taken)        |
