...
| 3   | Read the **STEP 5** output.                                                                                                                                                                                                                  | `ledger_rows = 43`; 10 migration names ≥ 20260710; `ml_cols = 16`; 2 `pipeline_cost_ledger` composite indexes; 2 `organization_video_quotas` policies; `daily-churn-score` `active = false`; `dead17_remaining = 0`; 5 `zzz_deprecated_*` tables. |
