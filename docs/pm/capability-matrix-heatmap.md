...
AT-001 / AT-002 / AT-003 / AT-004 / AT-005 / AT-006 / AT-007 / AT-011 / AT-012 / AT-016 /
...
- **C3 COMPLETE now exists for twelve rows:** AT-001 (orchestrate skill
  ...
  AT-006 (Hyper-Care daily), AT-007 (Tier-2 monthly),
...
| AT-005 | Tier-1 `loadAgencyBrandMetrics` from org-scoped Leads + gateCounts (cron + POST)           | (this)  |
