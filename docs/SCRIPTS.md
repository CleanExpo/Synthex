...
| Script                    | Status                        | Description                                          |
| ------------------------- | ----------------------------- | ---------------------------------------------------- |
| `setup-production.js`     | :no_entry: DELETED 2026-07-11 | Legacy secret-generator; unreferenced (parity audit) |
| `setup-production-env.ts` | :no_entry: REDUNDANT          | Removed lineage (`setup-production.js` deleted)      |
| `set-production-env.sh`   | :no_entry: REDUNDANT          | Removed lineage (`setup-production.js` deleted)      |
...
| `complete-integration.ts` | :no_entry: DELETED 2026-07-11 | Pointed users at the deleted legacy `supabase/complete-schema.sql` (parity audit) |
