...
| `CAMPAIGN_CONCEPT_TEXT_MODEL`    | Model for Responses API text generation in Campaign Concept Studio              | INTERNAL       | `gpt-4o-mini` |
| `CAMPAIGN_CONCEPT_IMAGE_MODEL`   | Image model for campaign image generation                                       | INTERNAL       | `dall-e-3`    |
| `CAMPAIGN_CONCEPT_IMAGE_SIZE`    | Image output size for generated visuals (`1024x1024`, `1024x1792`, `1792x1024`) | INTERNAL       | `1024x1024`   |
| `CAMPAIGN_CONCEPT_IMAGE_QUALITY` | Image quality for supported providers (`standard` or `hd`)                      | INTERNAL       | `standard`    |
| `CAMPAIGN_CONCEPT_MAX_TOKENS`    | Max text output tokens for concept generation                                   | INTERNAL       | `1400`        |
...
- **PUBLIC** 🟢: Safe for client-side exposure (use NEXT*PUBLIC* prefix).
...
_Generated on 2025-08-15T04:25:20.798Z_
