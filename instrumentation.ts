 ...
 * that kills the Lambda process before it handles any request.
 *
...
export async function register() {
  ...
  // ─────────────────────────────────────────────────────────────────────
  // EVERYTHING below is wrapped in try-catch. register() MUST NOT throw.
  // A throw causes an unhandled rejection that kills the Lambda process
  // before it can handle any request.
  // ─────────────────────────────────────────────────────────────────────
  try {
