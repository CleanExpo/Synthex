      ...
      <DialogContent className="bg-[#0d1829] border-white/[0.08] max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-white font-light">
            <div className="w-7 h-7 flex items-center justify-center bg-cyan-500/10 border-[0.5px] border-cyan-500/20 rounded-sm">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button
              className="flex-1 bg-cyan-500 hover:bg-cyan-400 text-[#0a1628] font-semibold"
