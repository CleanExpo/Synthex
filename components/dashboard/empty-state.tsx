  ...
  return (
    ...
    >
      ...
      <div className="mb-6 w-14 h-14 flex items-center justify-center border-[0.5px] border-white/[0.1] bg-white/[0.02] rounded-sm">
        <Icon className="h-6 w-6 text-amber-400/70" />
      </div>
      ...
      <div className="flex items-center gap-3">
        {action && (
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-amber-500 hover:bg-amber-400 text-[#050505] text-xs font-semibold tracking-wide rounded-sm transition-colors"
          >
