      ...
      <div className="px-6 pt-5 pb-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 border-[0.5px] border-cyan-500/30 bg-cyan-500/10 rounded-sm flex items-center justify-center flex-shrink-0">
          ...
          >
            ...
            >
              {step.completed ? (
                ...
                <step.icon className="h-3.5 w-3.5 text-white/40 group-hover:text-cyan-400 transition-colors" />
              )}
            </div>
            ...
            {!step.completed && (
              <ChevronRight className="h-3.5 w-3.5 text-white/20 group-hover:text-cyan-400 transition-colors flex-shrink-0" />
            )}
          </Link>
        ))}
      </div>
