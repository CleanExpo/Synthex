...
const DottedWorldMap = () => {
  ...
  return (
    <svg viewBox="0 0 120 55" className="w-full h-auto text-cyan-400/20">
      {dots.map((d, i) => (
        ...
        {feedMessages.map((msg, i) => (
          <div
            ...
            className={cn(
              ...
              'hover:bg-cyan-500/[0.04] transition-colors duration-200',
              'opacity-0'
            )}
            style={{
          ...
          <div className="relative mt-4">
            <div
              className={cn(
                ...
                'flex items-center gap-2 border-[0.5px] border-cyan-500/20'
              )}
            >
              <span className="text-cyan-400">●</span> Last connection from AU
            </div>
            <DottedWorldMap />
          </div>
        </div>
        ...
        >
          <div>
            <span className="text-xs flex items-center gap-2 text-white/40">
              <GalleryVerticalEnd className="w-4 h-4 text-cyan-400" />
