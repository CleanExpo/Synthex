...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    content:
      'This is your dashboard where you can see all your metrics and recent activity at a glance.',
  ...
  },
  {
    ...
    content:
      'Click here to generate viral-optimized content using our AI. It learns from top performers!',
  ...
  },
  {
    ...
    content:
      'Press Cmd+K (or Ctrl+K) anytime to quickly navigate or perform actions.',
    target: 'body',
    position: 'bottom',
    action: () => {
  ...
  },
  {
    ...
    content:
      'Upgrade to Pro to remove limits and access unlimited AI generations, workflows, and all integrations.',
  ...
  },
  {
    ...
    content:
      "Start creating amazing content that goes viral. We're here to help you succeed!",
    target: 'body',
    position: 'bottom',
    action: () => {
      confetti();
