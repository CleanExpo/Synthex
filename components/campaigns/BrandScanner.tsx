    ...
    <div className="border-[0.5px] border-white/6 bg-white/1.5 rounded-sm p-5">
      <div className="mb-4">
        ...
        <p className="text-xs text-white/35 mt-1 max-w-xl">
          Paste your website — we extract business name, industry, and a seed
          post for your campaign.
        </p>
      </div>
      ...
      >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-sm bg-orange-500 px-4 py-2.5 text-sm font-medium text-surface-dark hover:bg-orange-400 disabled:opacity-50 shrink-0"
        >
          {scanning ? (
            <>
      ...
      {state.phase === 'scanning' && (
        <div
          role="status"
          className="mt-4 flex items-center gap-2 text-xs text-white/45"
        >
