      ...
      <CardContent className="p-4">
        <div className="flex items-start justify-between mb-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="bg-slate-900/95 border-white/10"
            >
        ...
        {task.subtasks.length > 0 && (
          <div className="mb-3">
            ...
            <Progress
              value={(completedSubtasks / task.subtasks.length) * 100}
              className="h-1"
            />
          </div>
        )}
        ...
        <div className="flex items-center justify-between pt-3 border-t border-white/5">
          ...
          <div
            className={`flex items-center gap-1 text-xs ${isOverdue ? 'text-red-400' : 'text-slate-300'}`}
          >
