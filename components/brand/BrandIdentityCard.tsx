...
export function BrandIdentityCard({
  ...
  const sameAsPlatforms: SameAsPlatform[] = [
    { key: 'wikidata', label: 'Wikidata', url: identity.wikidataUrl ?? null },
    {
      key: 'wikipedia',
      label: 'Wikipedia',
      url: identity.wikipediaUrl ?? null,
    },
    { key: 'linkedin', label: 'LinkedIn', url: identity.linkedinUrl ?? null },
    {
      key: 'crunchbase',
      label: 'Crunchbase',
      url: identity.crunchbaseUrl ?? null,
    },
    ...
    { key: 'facebook', label: 'Facebook', url: identity.facebookUrl ?? null },
    {
      key: 'instagram',
      label: 'Instagram',
      url: identity.instagramUrl ?? null,
    },
  ];

  const kgPercent =
    identity.kgConfidence !== null && identity.kgConfidence !== undefined
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        <div className="bg-white/[0.03] rounded-lg p-3 text-center">
          <div
            className={cn(
              'text-xl font-bold',
              scoreColour(identity.consistencyScore)
            )}
          >
            {identity.consistencyScore !== null &&
            identity.consistencyScore !== undefined
        ...
        <div className="bg-white/[0.03] rounded-lg p-3 text-center">
          <div
            className={cn(
              'text-xl font-bold',
              identity.wikidataQId ? 'text-green-400' : 'text-gray-500'
            )}
          >
