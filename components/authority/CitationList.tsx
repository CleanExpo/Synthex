  ...
  return (
    <div className="space-y-3">
      ...
      {citations.map((citation, i) => (
        ...
        >
          <span className="text-xs text-slate-500 shrink-0 mt-0.5 font-mono">
            [{i + 1}]
          </span>
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1">
              <span
                className={`text-xs px-1.5 py-0.5 rounded ${SOURCE_COLORS[citation.sourceType] ?? SOURCE_COLORS.web}`}
              >
                {citation.sourceType}
              </span>
