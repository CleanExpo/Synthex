/**
 * BrainCircuit Icon - Custom SVG implementation
 * Used for AI/neural network circuit features
 */

import React from 'react';

interface BrainCircuitProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}
