  ...
  return (
    <div
      className={cn(
        ...
        "border-[0.5px] border-white/[0.06] rounded-sm bg-[#080e1a] p-1.5",
        "focus-within:border-cyan-500/40 focus-within:ring-[2px] focus-within:ring-cyan-500/10",
      ...
      {value.map((tag, index) => (
        <span
          ...
          className={cn(
            ...
            "bg-cyan-500/[0.10] border-[0.5px] border-cyan-500/20",
            "rounded-sm font-medium text-xs text-cyan-300",
          ...
          {!disabled && (
            <button
              ...
              className={cn(
                ...
                "text-cyan-300/60 hover:text-cyan-300 transition-colors duration-150",
                "focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-500/40"
              )}
