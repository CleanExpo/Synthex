  ...
  'block rounded-full ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        'glass-primary':
          'border-2 border-orange-500/50 bg-white shadow-[0_0_10px_rgba(245,158,11,0.4)]',
        'glass-secondary':
          'border-2 border-orange-500/50 bg-white shadow-[0_0_10px_rgba(245,158,11,0.4)]',
        'glass-success':
        ...
        // Gradient variants
        'gradient-primary':
          'border-0 bg-gradient-to-br from-orange-400 to-orange-400 shadow-[0_0_12px_rgba(245,158,11,0.5)]',
        'gradient-secondary':
          'border-0 bg-gradient-to-br from-orange-400 to-blue-400 shadow-[0_0_12px_rgba(245,158,11,0.5)]',
      },
      size: {
        default: 'h-5 w-5',
        sm: 'h-4 w-4',
