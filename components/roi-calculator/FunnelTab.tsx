          ...
          <div className="mt-6 p-4 bg-white/5 rounded-lg">
            ...
            <div className="space-y-1">
              <p className="text-xs text-gray-300">
                &bull; Highest drop-off at Product Views &rarr; Add to Cart
                (60%)
              </p>
              <p className="text-xs text-gray-300">
                &bull; Consider improving product page design and CTAs
              </p>
              <p className="text-xs text-gray-300">
                &bull; Implement cart abandonment recovery campaigns
              </p>
            </div>
          </div>
        </CardContent>
