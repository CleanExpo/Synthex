    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent variant="glass-solid" className="sm:max-w-md">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
          <span
            className={cn(
              step === 1 ? 'text-amber-400 font-semibold' : 'text-gray-500'
            )}
          >
            1 Template
          </span>
          ...
          <span
            className={cn(
              step === 2 ? 'text-amber-400 font-semibold' : 'text-gray-500'
            )}
          >
            2 Details
          </span>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-md bg-white/5 border border-white/10 text-sm text-white placeholder:text-gray-600 px-3 py-2 focus:outline-none focus:border-amber-500/50"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-md bg-white/5 border border-white/10 text-sm text-white placeholder:text-gray-600 px-3 py-2 resize-none font-mono text-xs focus:outline-none focus:border-amber-500/50"
              />
            </div>
          </div>
        )}
