  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className="mt-0.5 h-8 w-8 flex items-center justify-center border-[0.5px] border-[#FF6B35]/25 bg-[#FF6B35]/8 rounded-sm">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full bg-black/30 border-[0.5px] border-white/10 rounded-sm px-3 py-2.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-[#FF6B35]/40 resize-y min-h-[88px]"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full bg-black/30 border-[0.5px] border-white/10 rounded-sm px-3 py-2.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-[#FF6B35]/40 resize-y"
        />
      </div>
      ...
      <div className="flex justify-end">
        <button
          type="submit"
          disabled={disabled || busy}
          className="inline-flex items-center gap-2 px-4 py-2.5 text-xs font-medium tracking-wide rounded-sm bg-[#FF6B35] text-[#050508] hover:bg-[#ff7d4d] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
