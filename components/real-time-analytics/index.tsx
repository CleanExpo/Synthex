    ...
    const interval = setInterval(() => {
      setAnalyticsData(prev => ({
        ...
        overview: {
          ...prev.overview,
          totalReach:
            prev.overview.totalReach + Math.floor(Math.random() * 100),
          totalEngagement:
            prev.overview.totalEngagement + Math.floor(Math.random() * 10),
    ...
    try {
      ...
      setAnalyticsData(prev => ({
        ...
        overview: {
          ...prev.overview,
          totalReach:
            prev.overview.totalReach + Math.floor(Math.random() * 1000),
          totalEngagement:
            prev.overview.totalEngagement + Math.floor(Math.random() * 100),
        },
      }));
