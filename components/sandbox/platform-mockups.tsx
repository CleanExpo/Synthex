  ...
  return (
    <div className="bg-black rounded-lg p-4">
      <div className="flex items-start space-x-3">
        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-500 to-orange-500"></div>
    ...
    <div className="bg-white rounded-lg overflow-hidden">
      <div className="flex items-center justify-between p-3 border-b">
        <div className="flex items-center space-x-2">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-500"></div>
      ...
      {mediaType !== 'none' ? (
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-500 h-96 flex items-center justify-center">
