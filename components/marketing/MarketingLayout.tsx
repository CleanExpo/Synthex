      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/signup">
              <Button className="bg-orange-500 hover:bg-orange-400 text-charcoal-900 text-sm px-6 py-2 rounded-full font-bold transition-all">
                Get Started
              </Button>
            </Link>
          </div>
...
export default function MarketingLayout({
  ...
  return (
    <div className="min-h-screen bg-charcoal-900 text-white overflow-hidden">
      ...
      {/* Amber Glow Effects */}
      <div className="fixed top-1/4 left-1/4 w-96 h-96 bg-orange-500/[0.04] rounded-full blur-[150px] pointer-events-none" />
      <div className="fixed bottom-1/4 right-1/4 w-96 h-96 bg-orange-500/[0.03] rounded-full blur-[150px] pointer-events-none" />
