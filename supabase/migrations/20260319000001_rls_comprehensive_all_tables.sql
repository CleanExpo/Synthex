...
DO $$ BEGIN CREATE POLICY "service_role_ab_tests" ON public.ab_tests FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_ab_tests" ON public.ab_tests FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- api_credentials
ALTER TABLE IF EXISTS public.api_credentials ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_api_credentials" ON public.api_credentials FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_api_credentials" ON public.api_credentials FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- approval_requests
ALTER TABLE IF EXISTS public.approval_requests ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_approval_requests" ON public.approval_requests FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_approval_requests" ON public.approval_requests FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- business_ownerships
ALTER TABLE IF EXISTS public.business_ownerships ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_business_ownerships" ON public.business_ownerships FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_business_ownerships" ON public.business_ownerships FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- business_vetting_results
ALTER TABLE IF EXISTS public.business_vetting_results ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_business_vetting_results" ON public.business_vetting_results FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_business_vetting_results" ON public.business_vetting_results FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- calendar_posts
ALTER TABLE IF EXISTS public.calendar_posts ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_calendar_posts" ON public.calendar_posts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_calendar_posts" ON public.calendar_posts FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- campaigns
ALTER TABLE IF EXISTS public.campaigns ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_campaigns" ON public.campaigns FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_campaigns" ON public.campaigns FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- content_drafts
ALTER TABLE IF EXISTS public.content_drafts ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_content_drafts" ON public.content_drafts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_content_drafts" ON public.content_drafts FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- content_shares
ALTER TABLE IF EXISTS public.content_shares ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_content_shares" ON public.content_shares FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_content_shares" ON public.content_shares FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- onboarding_progress
ALTER TABLE IF EXISTS public.onboarding_progress ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_onboarding_progress" ON public.onboarding_progress FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_onboarding_progress" ON public.onboarding_progress FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- permission_audits
ALTER TABLE IF EXISTS public.permission_audits ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_permission_audits" ON public.permission_audits FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_permission_audits" ON public.permission_audits FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- platform_connections
ALTER TABLE IF EXISTS public.platform_connections ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_platform_connections" ON public.platform_connections FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_platform_connections" ON public.platform_connections FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- projects
ALTER TABLE IF EXISTS public.projects ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_projects" ON public.projects FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_projects" ON public.projects FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- prompt_templates
ALTER TABLE IF EXISTS public.prompt_templates ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_prompt_templates" ON public.prompt_templates FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_prompt_templates" ON public.prompt_templates FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- report_templates
ALTER TABLE IF EXISTS public.report_templates ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_report_templates" ON public.report_templates FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_report_templates" ON public.report_templates FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- reports
ALTER TABLE IF EXISTS public.reports ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_reports" ON public.reports FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_reports" ON public.reports FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- roles (org-scoped RBAC role definitions)
ALTER TABLE IF EXISTS public.roles ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_roles" ON public.roles FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_roles" ON public.roles FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- scheduled_reports
ALTER TABLE IF EXISTS public.scheduled_reports ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_scheduled_reports" ON public.scheduled_reports FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY "service_role_sentiment_trends" ON public.sentiment_trends FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_sentiment_trends" ON public.sentiment_trends FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- team_invitations
ALTER TABLE IF EXISTS public.team_invitations ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_team_invitations" ON public.team_invitations FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_team_invitations" ON public.team_invitations FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- team_notifications
ALTER TABLE IF EXISTS public.team_notifications ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_team_notifications" ON public.team_notifications FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_team_notifications" ON public.team_notifications FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- tracked_keywords
ALTER TABLE IF EXISTS public.tracked_keywords ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_tracked_keywords" ON public.tracked_keywords FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_tracked_keywords" ON public.tracked_keywords FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- users (special: row = own account only)
ALTER TABLE IF EXISTS public.users ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_users" ON public.users FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_row" ON public.users FOR SELECT TO authenticated USING (id = auth.uid()::text); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY "service_role_vault_access_logs" ON public.vault_access_logs FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY "service_role_vault_secrets" ON public.vault_secrets FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- video_generations
ALTER TABLE IF EXISTS public.video_generations ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_video_generations" ON public.video_generations FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_video_generations" ON public.video_generations FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- workflow_executions
ALTER TABLE IF EXISTS public.workflow_executions ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_workflow_executions" ON public.workflow_executions FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_workflow_executions" ON public.workflow_executions FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- workflow_templates
ALTER TABLE IF EXISTS public.workflow_templates ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_workflow_templates" ON public.workflow_templates FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
DO $$ BEGIN CREATE POLICY "users_select_own_org_workflow_templates" ON public.workflow_templates FOR SELECT TO authenticated USING (organization_id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY "service_role_accounts" ON public.accounts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- ab_test_results
ALTER TABLE IF EXISTS public.ab_test_results ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_ab_test_results" ON public.ab_test_results FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- ab_test_variants
ALTER TABLE IF EXISTS public.ab_test_variants ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_ab_test_variants" ON public.ab_test_variants FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- affiliate_link_clicks
ALTER TABLE IF EXISTS public.affiliate_link_clicks ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_affiliate_link_clicks" ON public.affiliate_link_clicks FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- ai_messages
ALTER TABLE IF EXISTS public.ai_messages ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_ai_messages" ON public.ai_messages FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- algorithm_updates (platform reference data)
ALTER TABLE IF EXISTS public.algorithm_updates ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_algorithm_updates" ON public.algorithm_updates FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- article_authors
ALTER TABLE IF EXISTS public.article_authors ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_article_authors" ON public.article_authors FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- bo_observations
ALTER TABLE IF EXISTS public.bo_observations ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_bo_observations" ON public.bo_observations FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- brand_dna
ALTER TABLE IF EXISTS public.brand_dna ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_brand_dna" ON public.brand_dna FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- competitive_analyses
ALTER TABLE IF EXISTS public.competitive_analyses ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_competitive_analyses" ON public.competitive_analyses FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- competitor_posts
ALTER TABLE IF EXISTS public.competitor_posts ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_competitor_posts" ON public.competitor_posts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- competitor_snapshots
ALTER TABLE IF EXISTS public.competitor_snapshots ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_competitor_snapshots" ON public.competitor_snapshots FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- content_comments
ALTER TABLE IF EXISTS public.content_comments ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_content_comments" ON public.content_comments FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- deal_deliverables
ALTER TABLE IF EXISTS public.deal_deliverables ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_deal_deliverables" ON public.deal_deliverables FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- experiment_observations
ALTER TABLE IF EXISTS public.experiment_observations ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_experiment_observations" ON public.experiment_observations FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- forecasts
ALTER TABLE IF EXISTS public.forecasts ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_forecasts" ON public.forecasts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- healing_actions
ALTER TABLE IF EXISTS public.healing_actions ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_healing_actions" ON public.healing_actions FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- invite_codes
ALTER TABLE IF EXISTS public.invite_codes ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_invite_codes" ON public.invite_codes FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- link_bio_links
ALTER TABLE IF EXISTS public.link_bio_links ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_link_bio_links" ON public.link_bio_links FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- organizations
ALTER TABLE IF EXISTS public.organizations ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_organizations" ON public.organizations FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
-- Allow authenticated users to view their own org
DO $$ BEGIN CREATE POLICY "users_select_own_org" ON public.organizations FOR SELECT TO authenticated USING (id IN (SELECT organization_id FROM public.users WHERE id = auth.uid()::text)); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- persona_training_data
ALTER TABLE IF EXISTS public.persona_training_data ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_persona_training_data" ON public.persona_training_data FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- platform_metrics
ALTER TABLE IF EXISTS public.platform_metrics ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_platform_metrics" ON public.platform_metrics FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- platform_posts
ALTER TABLE IF EXISTS public.platform_posts ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_platform_posts" ON public.platform_posts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- posts
ALTER TABLE IF EXISTS public.posts ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_posts" ON public.posts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- psychology_metrics
ALTER TABLE IF EXISTS public.psychology_metrics ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_psychology_metrics" ON public.psychology_metrics FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- psychology_principles (reference/lookup table)
ALTER TABLE IF EXISTS public.psychology_principles ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_psychology_principles" ON public.psychology_principles FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY "service_role_report_deliveries" ON public.report_deliveries FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- sentinel_alerts
ALTER TABLE IF EXISTS public.sentinel_alerts ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_sentinel_alerts" ON public.sentinel_alerts FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- seo_experiments
ALTER TABLE IF EXISTS public.seo_experiments ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_seo_experiments" ON public.seo_experiments FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- site_health_snapshots
ALTER TABLE IF EXISTS public.site_health_snapshots ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_site_health_snapshots" ON public.site_health_snapshots FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- sponsor_deals
ALTER TABLE IF EXISTS public.sponsor_deals ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_sponsor_deals" ON public.sponsor_deals FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

-- step_executions
ALTER TABLE IF EXISTS public.step_executions ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_step_executions" ON public.step_executions FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY "service_role_AuthorityAnalysis" ON public."AuthorityAnalysis" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."AuthorityCitation" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_AuthorityCitation" ON public."AuthorityCitation" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."AwardListing" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_AwardListing" ON public."AwardListing" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."BacklinkAnalysis" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_BacklinkAnalysis" ON public."BacklinkAnalysis" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."BacklinkProspect" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_BacklinkProspect" ON public."BacklinkProspect" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."BrandCredential" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_BrandCredential" ON public."BrandCredential" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."BrandIdentity" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_BrandIdentity" ON public."BrandIdentity" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."BrandMention" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_BrandMention" ON public."BrandMention" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."CitationMonitor" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_CitationMonitor" ON public."CitationMonitor" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."ContentCapsule" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_ContentCapsule" ON public."ContentCapsule" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."ContentQualityAudit" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_ContentQualityAudit" ON public."ContentQualityAudit" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."DirectoryListing" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_DirectoryListing" ON public."DirectoryListing" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."EEATAudit" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_EEATAudit" ON public."EEATAudit" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."JournalistContact" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_JournalistContact" ON public."JournalistContact" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."MediaCoverage" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_MediaCoverage" ON public."MediaCoverage" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."PRDistribution" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_PRDistribution" ON public."PRDistribution" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."PRPitch" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_PRPitch" ON public."PRPitch" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."PressRelease" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_PressRelease" ON public."PressRelease" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."PromptResult" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_PromptResult" ON public."PromptResult" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."PromptTracker" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_PromptTracker" ON public."PromptTracker" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."SubmissionTracker" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_SubmissionTracker" ON public."SubmissionTracker" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;

ALTER TABLE IF EXISTS public."VoiceProfile" ENABLE ROW LEVEL SECURITY;
DO $$ BEGIN CREATE POLICY "service_role_VoiceProfile" ON public."VoiceProfile" FOR ALL TO service_role USING (true) WITH CHECK (true); EXCEPTION WHEN duplicate_object THEN NULL; WHEN undefined_table THEN NULL; WHEN undefined_column THEN NULL; END $$;
