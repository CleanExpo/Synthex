...
class NotificationSystem {
  ...
  getIcon(type) {
    const icons = {
      ...
      campaign:
        '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z"/></svg>',
      content:
  ...
  getIconBackground(type) {
    const backgrounds = {
      ...
      campaign: 'rgba(245, 158, 11, 0.1)',
      content: 'rgba(245, 158, 11, 0.1)',
    ...
    this.notifications = [
      {
        ...
        message:
          'Your "Summer Sale 2024" campaign is now live across all platforms.',
        read: false,
      ...
      },
      {
        ...
        message:
          'Your weekly analytics report is ready. Total reach increased by 23%!',
        read: false,
      ...
      },
      {
        ...
        message:
          'You have 3 posts scheduled for tomorrow. Review them before they go live.',
        read: true,
